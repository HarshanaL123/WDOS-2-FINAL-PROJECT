...
function calculateBooking() {
  ...
  const mealCost = childrenCount * 5000.00; // If add children--need to count 5000 for each
  ...
  const overallBookingCost = `${totalCost.toFixed(2)} LKR`;
  ...
  document.getElementById('overallCost').innerText = overallBookingCost;
}
...
function calculateBookingAD() {
  ...
  document.getElementById('overallCost.AD').innerText = overallBookingCost;
}
